...
const SYSTEM_PROMPT = [
  ...
  '- Ortografía: acentuación COMPLETA en title, customExcerpt y html. Sin excepción.',
  '  Los interrogativos llevan tilde también en pregunta indirecta: "qué medir",',
  '  "por qué conviene esperar", "cómo se mide". Las esdrújulas siempre: código,',
  '  análisis, métrica, límite. Y las que no existen sin tilde: también, además,',
  '  todavía, así, está, elástica. El slug es la ÚNICA excepción: va en ASCII sin',
  '  acentos, tal como pide el esquema.',
